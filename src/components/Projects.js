        ...
        <CardDeck className="deck">
          <Col md={4} xl={2}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Secure location to reference and save URLs and cheat sheets
                  for web development. Built with MERN Stack, React-Router,
                  Materialize CSS.
                </Card.Text>
              </Card.Body>
              <Card.Footer>
            ...
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  ...
                  jQuery to make AJAX calls to 3rd party APIs utilizing
                  Foudation CSS framework.
                </Card.Text>
              </Card.Body>
              <Card.Footer>
          ...
          <Col md={4} xl={2}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Built with React, this employee directory breaks up
            ...
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  PWA aplication built with NodeJS where the user can add
                  expenses and deposits with or without a connection.
                </Card.Text>
              </Card.Body>
              <Card.Footer>
